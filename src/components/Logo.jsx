...
function BrandTelegram({ className }) {
  /* 
...
function ArrowNarrowRight({ className }) {
  /*
...
function EmailIcon({ size = 24, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export { BrandLinkedin, BrandTelegram, BrandWhatsapp, BrandInstagram, BrandGithub, ArrowNarrowRight, ArrowUpRight, EmailIcon};